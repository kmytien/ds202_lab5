...
##### keeps giving me cannot allocate vector error
#Summer
#monthsS <- summerMonths %>% left_join(usa, by = c("STATE" = "State Code")) %>%
#         select(STATE, `State Name`, FATALS) %>%
#         unique()

#monthsS <- monthsS %>% left_join(states, by = c("State Name" = "region"))

#Winter
#monthsW <- winterMonths %>% left_join(usa, by = c("STATE" = "State Code")) %>%
#         select(STATE, `State Name`, FATALS) %>%
#         unique()

#monthsW <- monthsW %>% left_join(states, by = c("State Name" = "region"))
#####
